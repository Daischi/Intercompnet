...
import { Cpu, Download, Gamepad, HardDrive, Printer, RefreshCcw, ServerCog, Settings, Shield, Wifi } from "lucide-react";
...
export default function ServicesTabs() {
  ...
  <div>
    <TabsContent value="computadores">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
        <Card>
          ...
          <CardContent>Serviços completos para desktops e notebooks.</CardContent>
        </Card>
    ...
    <TabsContent className="w-max" value="impressoras">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
        <Card>
          <CardHeader>
        ...
        <Card>
          ...
          <CardContent>Configuração e ajustes de impressoras.</CardContent>
        </Card>
    ...
    <TabsContent value="redes">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
        <Card>
          ...
          <CardContent>Instalação e configuração de redes locais.</CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>Proteção contra ataques e vulnerabilidades.</CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>Configuração e manutenção de servidores.</CardContent>
        </Card>
      </div>
    </TabsContent>
    ...
    <TabsContent value="video-games">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
        <Card>
          ...
          <CardContent>Manutenção e conserto de consoles de videogame.</CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            <Cpu className="w-6 h-6" />
            <CardTitle>Upgrade de Hardware</CardTitle>
          </CardHeader>
          <CardContent>Melhoria de desempenho em consoles e PCs gamers.</CardContent>
        </Card>
      </div>
    </TabsContent>
  </div>
